...
export default function BallInfo({ 
  ...
  return (
    <section className="red-frame h-screen w-full flex items-center md:items-center bg-black relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 md:px-16 w-full grid grid-cols-1 md:grid-cols-5 items-center gap-8 pt-56 pb-20 md:py-20">
        <motion.div 
        ...
        >
          ...
          <h2 className="text-4xl sm:text-7xl md:text-9xl font-display font-bold uppercase tracking-tighter leading-[0.85] mb-6 md:mb-12">
          ...
          <div className="space-y-6 md:space-y-12">
            <div className="flex gap-4 md:gap-8 items-start">
              ...
              <div>
                <h3 className="text-2xl md:text-5xl font-display font-bold mb-1 md:mb-2">{currentProduct.specs.material.split(' ')[0]}</h3>
            ...
            <div className="flex gap-4 md:gap-8 items-start">
              <div className="w-px h-12 md:h-24 bg-white/10 shrink-0" />
              <div>
                <h3 className="text-2xl md:text-5xl font-display font-bold mb-1 md:mb-2">{currentProduct.specs.depth}</h3>
          ...
          <motion.button 
            onClick={onNextToSpec}
            initial={{ opacity: 0 }}
            whileInView={{ opacity: 1 }}
            transition={{ delay: 1 }}
            className="mt-8 md:mt-16 flex items-center gap-4 group cursor-pointer w-fit"
          >
      ...
      <div className="absolute bottom-8 md:bottom-12 left-8 md:left-16 flex items-center gap-8 z-20">
        <button 
